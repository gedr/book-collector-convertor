...
public class OrmHelper {
	...
	private ThreadLocalMulti<Session> localSession = new ThreadLocalMulti<>();
	private ThreadLocalMulti<Transaction> localTransaction = new ThreadLocalMulti<>();
	private ThreadLocalMulti<Boolean> localMultiplex = new ThreadLocalMulti<>();
	...
	public static class QueryAttrs {
		...
		public QueryAttrs setParam(String name, char val) {
			addParam(new QueryParam(QueryParam.PARAM_TYPE.CHAR, name, val));
			return this;
		}

		public QueryAttrs setParam(String name, boolean val) {
			addParam(new QueryParam(QueryParam.PARAM_TYPE.BOOLEAN, name, val));
			return this;
		}

		public QueryAttrs setParam(String name, byte val) {
			addParam(new QueryParam(QueryParam.PARAM_TYPE.BYTE, name, val));
			return this;
		}

		public QueryAttrs setParam(String name, short val) {
			addParam(new QueryParam(QueryParam.PARAM_TYPE.SHORT, name, val));
			return this;
		}

		public QueryAttrs setParam(String name, int val) {
			addParam(new QueryParam(QueryParam.PARAM_TYPE.INT, name, val));
			return this;
		}

		public QueryAttrs setParam(String name, long val) {
			addParam(new QueryParam(QueryParam.PARAM_TYPE.LONG, name, val));
			return this;
		}

		public QueryAttrs setParam(String name, float val) {
			addParam(new QueryParam(QueryParam.PARAM_TYPE.FLOAT, name, val));
			return this;
		}

		public QueryAttrs setParam(String name, double val) {
			addParam(new QueryParam(QueryParam.PARAM_TYPE.DOUBLE, name, val));
			return this;
		}
